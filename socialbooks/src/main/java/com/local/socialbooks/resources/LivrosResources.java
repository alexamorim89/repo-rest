...
import com.local.socialbooks.services.LivrosService;
...
public class LivrosResources {
	...
	public ResponseEntity<Void> adicionarComnetario(@Valid @PathVariable("id") long livroId, 
	...
	public ResponseEntity<List<Comentario>> listarComentarios(@PathVariable("id") Long livroId){
		List<Comentario> comentarios = this.livrosService.listarComentarios(livroId);
