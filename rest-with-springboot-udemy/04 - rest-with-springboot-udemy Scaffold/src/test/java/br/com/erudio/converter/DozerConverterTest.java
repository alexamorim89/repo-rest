...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        PersonVO1 output = DozerConverter.parseObject(inputObject.mockEntity(), PersonVO1.class);
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO1> outputList = DozerConverter.parseListObjects(inputObject.mockEntityList(), PersonVO1.class);
        PersonVO1 outputZero = outputList.get(0);
        ...
        PersonVO1 outputSeven = outputList.get(7);
        ...
        PersonVO1 outputTwelve = outputList.get(12);
